...
const imgUrl =
	'/home/jason/Documents/newestProjectShow/backend/public/images/files-1572787372229-fox-4589927_960_720.jpg';
...
conn.postTransactionCommit(txCreateSimpleSigned).then((res) => {
	console.log(res);
});
